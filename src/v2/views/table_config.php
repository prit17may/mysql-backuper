                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <div class="pull-right">
                                        <?php if (!has_only_pk($database, $table_name)) {
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            foreach ($cols as $col) {
                                                ...
                                                <div class="col-lg-<?php echo $col_value ?> col-md-<?php echo $col_value ?> col-sm-<?php echo $col_value ?> col-xs-<?php echo $col_value ?>" style="margin-bottom:0px<?php if ($col_value == 12 || $col_value == 6 || $col_value == 4 || $col_value == 4) {
